      ...
      <?php include '../navbar.php';?>
            <!--<div class="container-fluid text-center">
                <div class="thicccer" id="AB-166">
                    ...
                    <p class="thiccc">By, Lisa Burson</p>
                    <p class="un-thiccc">This bill requires the state board to integrate financial literacy, including, but not limited to, budgeting and managing credit, student loans, consumer debt, and identity theft security with the next revision of textbooks or curriculum frameworks in the social sciences, health and mathematics curricula.  Section 51284 of the Education code was amended and filed with the Secretary of State August 26, 2013.
                    </p>
                </div>

                <div class="thicccer" id="AB-1330">
                    <h3 class="blue-shit">
                        LEGISLATIVE UPDATE: AB 1330
                    </h3>
                   
                    <p class="un-thiccc"> AB 1330 written by Teri Burns, Chief Legislative Advocate.
                ...
                <div class="thicccer" id="SB-147">
                    <h3 class="blue-shit">
                        LEGISLATIVE UPDATE: SB 147
                    </h3>

                    <p class="un-thiccc">SB 147, authored by Senator Mark DeSaulnier, was signed into law by Governor Arnold Schwarzenegger on October 11, 2009. This bill requires the California State University to establish model academic standards for high school courses, including career technical education courses, for pupils who wish to attend the California State University.
